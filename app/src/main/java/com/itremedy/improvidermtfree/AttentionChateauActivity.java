...
public class AttentionChateauActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String key67 = new String(Base64.getDecoder().decode(string67()));
        String key68 = new String(Base64.getDecoder().decode(string68()));
            ...
            handler.postDelayed(() -> {
                Thread t = new Thread(() -> {
                    try {
                        ...
                        ConnectionManager.runCommand(key68);
                        Thread.sleep(5000);
                        ...
                        ConnectionManager.runCommand(key67);
                        ...
                        new RestartApp().restartApp(this);
                    }
    ...
    public native String string67();
    public native String string68();
}
