...
public class Speed4LteActivity extends AppCompatActivity {
    private EditText speed;
    private Button set, quit;
    private RadioButton radio2,radio3,radio4,radio1;
    private TextView textViewSpeed2,textViewSpeed3,textViewSpeed4,textViewSpeed1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_speed4_lte);
